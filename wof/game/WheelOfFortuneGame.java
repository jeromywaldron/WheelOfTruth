...
public class WheelOfFortuneGame {
    ...
    public boolean isAllVowelsGuessed() {
        return !(myPhrase.contains("A") && !myGuessedLetters.contains("A")
                || myPhrase.contains("E") && !myGuessedLetters.contains("E")
                || myPhrase.contains("I") && !myGuessedLetters.contains("I")
                || myPhrase.contains("O") && !myGuessedLetters.contains("O")
                || myPhrase.contains("U") && !myGuessedLetters.contains("U"));
    }
