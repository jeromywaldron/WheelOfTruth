...
public class WheelOfFortuneWheelPanel extends JPanel {
    ...
    static {
        ...
        IMAGE_NAMES =
                new String[]{"300.png", "750.png", "500.png",
                        "loseATurn.png", "1000.png", "600.png",
                        "350.png", "950.png", "800.png", "550.png",
                        "450.png", "700.png", "bankrupt.png",
                        "650.png", "250.png", "900.png", "400.png",
                        "850.png"};
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < myImageNames.size() / 2; i++) {
            g2D.setColor(WHEEL_COLORS.get(myImageNames.get(i)
                    .substring(0, myImageNames.get(i).indexOf('.'))));
    ...
    private void handleWin() {
        ...
        JOptionPane.showMessageDialog(null,
                "Congratulations, you win $" + myGame.getScore()
                        + "!\n\n", "You Win!",
    ...
    private void showHowToPlay() {
        JOptionPane
                .showMessageDialog(
                        null,
                        "To guess a consonant, you must first spin the wheel "
                                + "(Press \"Spin Wheel\" to\nspin it, and \"Stop "
                                + "Wheel\" to stop it). You will be awarded the amount "
                                + "on the\nspace times the number of appearances of "
                                + "the consonant in the puzzle. You\nlose a turn if "
                                + "the consonant does not appear in the puzzle.\n\n"
                                + "You may buy a vowel at any time if you have at "
                                + "least $250. Vowels cost a flat\nrate of $250; extra "
                                + "money will not be deducted for multiple occurrences "
                                + "of the\nvowel in the puzzle. If the vowel does not "
                                + "appear in the puzzle, you lose a turn\nin addition "
                                + "to the $250.\n\nThere are two non-cash amount "
                                + "spaces on the wheel: \"Bankrupt\" and \"Lose a\n"
                                + "Turn\", both of which make you lose a turn. In "
                                + "addition, \"Bankrupt\" brings your\nscore down to 0."
                                + "\n\nTo win the game, you must solve the puzzle "
                                + "within 7 turns. If you fail to do this,\nyou lose. "
            ...
            for (int c = 0; c < letterButtons.length; c++)
                if (source == letterButtons[c]) {
                    ...
                    if (c == 0 || c == 4 || c == 8 || c == 14
                        ...
                        if (appearances > 0) {
                            int amount =
                                    Integer.parseInt(mySpaceLanded
                                            .substring(0, mySpaceLanded
                                                    .indexOf('.')));
            ...
            if (source == spinWheel) {
                ...
                if (cmd.equals("Spin Wheel")) {
                    ...
                    if (mySpaceLanded.equals("loseATurn.png")) {
                        ...
                        statusArea
                                .setText("Sorry, you lose a turn, and "
                        ...
                        statusArea
                                .setText("Please select a consonant.");
                ...
                if (trimmedAttempt != "")
                    if (trimmedAttempt
                            .compareToIgnoreCase(trimmedPhrase) == 0)
                        handleWin();
                    else
